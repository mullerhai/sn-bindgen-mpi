...
object enumerations:
  import predef.*
  opaque type BIO_hostserv_priorities = CInt
  object BIO_hostserv_priorities extends _BindgenEnumCInt[BIO_hostserv_priorities]:
    given _tag: Tag[BIO_hostserv_priorities] = Tag.Int
    inline def define(inline a: CInt): BIO_hostserv_priorities = a
  ...
  opaque type BIO_lookup_type = CInt
  object BIO_lookup_type extends _BindgenEnumCInt[BIO_lookup_type]:
    given _tag: Tag[BIO_lookup_type] = Tag.Int
    inline def define(inline a: CInt): BIO_lookup_type = a
  ...
  opaque type BIO_sock_info_type = CInt
  object BIO_sock_info_type extends _BindgenEnumCInt[BIO_sock_info_type]:
    given _tag: Tag[BIO_sock_info_type] = Tag.Int
    inline def define(inline a: CInt): BIO_sock_info_type = a
...
object aliases:
  ...
  opaque type CRYPTO_ONCE = CUnsignedInt
  object CRYPTO_ONCE: 
    given _tag: Tag[CRYPTO_ONCE] = Tag.UInt
    inline def apply(inline o: CUnsignedInt): CRYPTO_ONCE = o
  ...
  opaque type CRYPTO_THREAD_ID = CUnsignedInt
  object CRYPTO_THREAD_ID: 
    given _tag: Tag[CRYPTO_THREAD_ID] = Tag.UInt
    inline def apply(inline o: CUnsignedInt): CRYPTO_THREAD_ID = o
    extension (v: CRYPTO_THREAD_ID)
      inline def value: CUnsignedInt = v

  opaque type CRYPTO_THREAD_LOCAL = CUnsignedInt
  object CRYPTO_THREAD_LOCAL: 
    given _tag: Tag[CRYPTO_THREAD_LOCAL] = Tag.UInt
    inline def apply(inline o: CUnsignedInt): CRYPTO_THREAD_LOCAL = o
...
object structs:
  ...
  opaque type BIO_POLL_DESCRIPTOR = CStruct2[uint32_t, BIO_POLL_DESCRIPTOR.Union0]
  object BIO_POLL_DESCRIPTOR:
    ...
    given _tag: Tag[BIO_POLL_DESCRIPTOR] = Tag.materializeCStruct2Tag[uint32_t, BIO_POLL_DESCRIPTOR.Union0]
    def apply()(using Zone): Ptr[BIO_POLL_DESCRIPTOR] = scala.scalanative.unsafe.alloc[BIO_POLL_DESCRIPTOR](1)
    def apply(`type` : uint32_t, value : BIO_POLL_DESCRIPTOR.Union0)(using Zone): Ptr[BIO_POLL_DESCRIPTOR] = 
      val ____ptr = apply()
      (!____ptr).`type` = `type`
      (!____ptr).value = value
      ____ptr
    extension (struct: BIO_POLL_DESCRIPTOR)
      ...
      def value : BIO_POLL_DESCRIPTOR.Union0 = struct._2
      def value_=(value: BIO_POLL_DESCRIPTOR.Union0): Unit = !struct.at2 = value
  ...
  opaque type bio_poll_descriptor_st = CStruct2[uint32_t, bio_poll_descriptor_st.Union0]
  object bio_poll_descriptor_st:
    ...
    object Union0:
      ...
      extension (struct: Union0)
        ...
        def ssl : Ptr[SSL] = !struct.at(0).asInstanceOf[Ptr[Ptr[SSL]]]
        def ssl_=(value: Ptr[SSL]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[SSL]]] = value
    given _tag: Tag[bio_poll_descriptor_st] = Tag.materializeCStruct2Tag[uint32_t, bio_poll_descriptor_st.Union0]
    def apply()(using Zone): Ptr[bio_poll_descriptor_st] = scala.scalanative.unsafe.alloc[bio_poll_descriptor_st](1)
    def apply(`type` : uint32_t, value : bio_poll_descriptor_st.Union0)(using Zone): Ptr[bio_poll_descriptor_st] = 
      val ____ptr = apply()
      (!____ptr).`type` = `type`
      (!____ptr).value = value
      ____ptr
    extension (struct: bio_poll_descriptor_st)
      def `type` : uint32_t = struct._1
      def type_=(value: uint32_t): Unit = !struct.at1 = value
      def value : bio_poll_descriptor_st.Union0 = struct._2
      def value_=(value: bio_poll_descriptor_st.Union0): Unit = !struct.at2 = value
...
private[openssl] object extern_functions:
  ...
  def BN_abs_is_word(a : Ptr[BIGNUM], w : CUnsignedLongLong): CInt = extern

  def BN_add(r : Ptr[BIGNUM], a : Ptr[BIGNUM], b : Ptr[BIGNUM]): CInt = extern

  def BN_add_word(a : Ptr[BIGNUM], w : CUnsignedLongLong): CInt = extern
  ...
  def BN_consttime_swap(swap : CUnsignedLongLong, a : Ptr[BIGNUM], b : Ptr[BIGNUM], nwords : CInt): Unit = extern
  ...
  def BN_div_word(a : Ptr[BIGNUM], w : CUnsignedLongLong): CUnsignedLongLong = extern
  ...
  def BN_get_word(a : Ptr[BIGNUM]): CUnsignedLongLong = extern
  ...
  */
  ...
  def BN_is_word(a : Ptr[BIGNUM], w : CUnsignedLongLong): CInt = extern
  ...
  def BN_mod_exp_mont_word(r : Ptr[BIGNUM], a : CUnsignedLongLong, p : Ptr[BIGNUM], m : Ptr[BIGNUM], ctx : Ptr[BN_CTX], m_ctx : Ptr[BN_MONT_CTX]): CInt = extern
  ...
  def BN_mod_word(a : Ptr[BIGNUM], w : CUnsignedLongLong): CUnsignedLongLong = extern
  ...
  def BN_mul_word(a : Ptr[BIGNUM], w : CUnsignedLongLong): CInt = extern
  ...
  def BN_num_bits_word(l : CUnsignedLongLong): CInt = extern
  ...
  */
  ...
  def BN_set_word(a : Ptr[BIGNUM], w : CUnsignedLongLong): CInt = extern
  ...
  def BN_sub_word(a : Ptr[BIGNUM], w : CUnsignedLongLong): CInt = extern
