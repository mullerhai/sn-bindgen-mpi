...
object enumerations:
  import predef.*
  opaque type CURLFORMcode = CInt
  object CURLFORMcode extends _BindgenEnumCInt[CURLFORMcode]:
    given _tag: Tag[CURLFORMcode] = Tag.Int
    inline def define(inline a: CInt): CURLFORMcode = a
  ...
  opaque type CURLHcode = CInt
  object CURLHcode extends _BindgenEnumCInt[CURLHcode]:
    given _tag: Tag[CURLHcode] = Tag.Int
    inline def define(inline a: CInt): CURLHcode = a
  ...
  object CURLINFO extends _BindgenEnumCInt[CURLINFO]:
    given _tag: Tag[CURLINFO] = Tag.Int
    inline def define(inline a: CInt): CURLINFO = a
  ...
  opaque type CURLMSG = CInt
  object CURLMSG extends _BindgenEnumCInt[CURLMSG]:
    given _tag: Tag[CURLMSG] = Tag.Int
    inline def define(inline a: CInt): CURLMSG = a
  ...
  opaque type CURLMoption = CInt
  object CURLMoption extends _BindgenEnumCInt[CURLMoption]:
    given _tag: Tag[CURLMoption] = Tag.Int
    inline def define(inline a: CInt): CURLMoption = a
  ...
  opaque type CURLSHcode = CInt
  object CURLSHcode extends _BindgenEnumCInt[CURLSHcode]:
    given _tag: Tag[CURLSHcode] = Tag.Int
    inline def define(inline a: CInt): CURLSHcode = a
  ...
  opaque type CURLSHoption = CInt
  object CURLSHoption extends _BindgenEnumCInt[CURLSHoption]:
    given _tag: Tag[CURLSHoption] = Tag.Int
    inline def define(inline a: CInt): CURLSHoption = a
  ...
  opaque type CURLSTScode = CInt
  object CURLSTScode extends _BindgenEnumCInt[CURLSTScode]:
    given _tag: Tag[CURLSTScode] = Tag.Int
    inline def define(inline a: CInt): CURLSTScode = a
  ...
  opaque type CURLUPart = CInt
  object CURLUPart extends _BindgenEnumCInt[CURLUPart]:
    given _tag: Tag[CURLUPart] = Tag.Int
    inline def define(inline a: CInt): CURLUPart = a
  ...
  opaque type CURLUcode = CInt
  object CURLUcode extends _BindgenEnumCInt[CURLUcode]:
    given _tag: Tag[CURLUcode] = Tag.Int
    inline def define(inline a: CInt): CURLUcode = a
  ...
  opaque type CURL_NETRC_OPTION = CInt
  object CURL_NETRC_OPTION extends _BindgenEnumCInt[CURL_NETRC_OPTION]:
    given _tag: Tag[CURL_NETRC_OPTION] = Tag.Int
    inline def define(inline a: CInt): CURL_NETRC_OPTION = a
  ...
  opaque type CURL_TLSAUTH = CInt
  object CURL_TLSAUTH extends _BindgenEnumCInt[CURL_TLSAUTH]:
    given _tag: Tag[CURL_TLSAUTH] = Tag.Int
    inline def define(inline a: CInt): CURL_TLSAUTH = a
  ...
  object CURLcode extends _BindgenEnumCInt[CURLcode]:
    given _tag: Tag[CURLcode] = Tag.Int
    inline def define(inline a: CInt): CURLcode = a
  ...
  opaque type CURLformoption = CInt
  object CURLformoption extends _BindgenEnumCInt[CURLformoption]:
    given _tag: Tag[CURLformoption] = Tag.Int
    inline def define(inline a: CInt): CURLformoption = a
  ...
  opaque type CURLoption = CInt
  object CURLoption extends _BindgenEnumCInt[CURLoption]:
    given _tag: Tag[CURLoption] = Tag.Int
    inline def define(inline a: CInt): CURLoption = a
    ...
    val CURLOPT_LASTENTRY = define(327)
  ...
  opaque type CURLproxycode = CInt
  object CURLproxycode extends _BindgenEnumCInt[CURLproxycode]:
    given _tag: Tag[CURLproxycode] = Tag.Int
    inline def define(inline a: CInt): CURLproxycode = a
  ...
  opaque type CURLsslset = CInt
  object CURLsslset extends _BindgenEnumCInt[CURLsslset]:
    given _tag: Tag[CURLsslset] = Tag.Int
    inline def define(inline a: CInt): CURLsslset = a
  ...
  */
  opaque type CURLversion = CInt
  object CURLversion extends _BindgenEnumCInt[CURLversion]:
    given _tag: Tag[CURLversion] = Tag.Int
    inline def define(inline a: CInt): CURLversion = a
  ...
  opaque type curl_TimeCond = CInt
  object curl_TimeCond extends _BindgenEnumCInt[curl_TimeCond]:
    given _tag: Tag[curl_TimeCond] = Tag.Int
    inline def define(inline a: CInt): curl_TimeCond = a
  ...
  opaque type curl_closepolicy = CInt
  object curl_closepolicy extends _BindgenEnumCInt[curl_closepolicy]:
    given _tag: Tag[curl_closepolicy] = Tag.Int
    inline def define(inline a: CInt): curl_closepolicy = a
  ...
  opaque type curl_easytype = CInt
  object curl_easytype extends _BindgenEnumCInt[curl_easytype]:
    given _tag: Tag[curl_easytype] = Tag.Int
    inline def define(inline a: CInt): curl_easytype = a
  ...
  opaque type curl_ftpauth = CInt
  object curl_ftpauth extends _BindgenEnumCInt[curl_ftpauth]:
    given _tag: Tag[curl_ftpauth] = Tag.Int
    inline def define(inline a: CInt): curl_ftpauth = a
  ...
  opaque type curl_ftpccc = CInt
  object curl_ftpccc extends _BindgenEnumCInt[curl_ftpccc]:
    given _tag: Tag[curl_ftpccc] = Tag.Int
    inline def define(inline a: CInt): curl_ftpccc = a
  ...
  opaque type curl_ftpcreatedir = CInt
  object curl_ftpcreatedir extends _BindgenEnumCInt[curl_ftpcreatedir]:
    given _tag: Tag[curl_ftpcreatedir] = Tag.Int
    inline def define(inline a: CInt): curl_ftpcreatedir = a
  ...
  opaque type curl_ftpmethod = CInt
  object curl_ftpmethod extends _BindgenEnumCInt[curl_ftpmethod]:
    given _tag: Tag[curl_ftpmethod] = Tag.Int
    inline def define(inline a: CInt): curl_ftpmethod = a
  ...
  opaque type curl_infotype = CInt
  object curl_infotype extends _BindgenEnumCInt[curl_infotype]:
    given _tag: Tag[curl_infotype] = Tag.Int
    inline def define(inline a: CInt): curl_infotype = a
  ...
  opaque type curl_khmatch = CInt
  object curl_khmatch extends _BindgenEnumCInt[curl_khmatch]:
    given _tag: Tag[curl_khmatch] = Tag.Int
    inline def define(inline a: CInt): curl_khmatch = a
  ...
  opaque type curl_khstat = CInt
  object curl_khstat extends _BindgenEnumCInt[curl_khstat]:
    given _tag: Tag[curl_khstat] = Tag.Int
    inline def define(inline a: CInt): curl_khstat = a
  ...
  opaque type curl_khtype = CInt
  object curl_khtype extends _BindgenEnumCInt[curl_khtype]:
    given _tag: Tag[curl_khtype] = Tag.Int
    inline def define(inline a: CInt): curl_khtype = a
  ...
  opaque type curl_lock_access = CInt
  object curl_lock_access extends _BindgenEnumCInt[curl_lock_access]:
    given _tag: Tag[curl_lock_access] = Tag.Int
    inline def define(inline a: CInt): curl_lock_access = a
  ...
  */
  opaque type curl_lock_data = CInt
  object curl_lock_data extends _BindgenEnumCInt[curl_lock_data]:
    given _tag: Tag[curl_lock_data] = Tag.Int
    inline def define(inline a: CInt): curl_lock_data = a
  ...
  opaque type curl_proxytype = CInt
  object curl_proxytype extends _BindgenEnumCInt[curl_proxytype]:
    given _tag: Tag[curl_proxytype] = Tag.Int
    inline def define(inline a: CInt): curl_proxytype = a
  ...
  opaque type curl_sslbackend = CInt
  object curl_sslbackend extends _BindgenEnumCInt[curl_sslbackend]:
    given _tag: Tag[curl_sslbackend] = Tag.Int
    inline def define(inline a: CInt): curl_sslbackend = a
  ...
  opaque type curl_usessl = CInt
  object curl_usessl extends _BindgenEnumCInt[curl_usessl]:
    given _tag: Tag[curl_usessl] = Tag.Int
    inline def define(inline a: CInt): curl_usessl = a
  ...
  opaque type curlfiletype = CInt
  object curlfiletype extends _BindgenEnumCInt[curlfiletype]:
    given _tag: Tag[curlfiletype] = Tag.Int
    inline def define(inline a: CInt): curlfiletype = a
  ...
  opaque type curliocmd = CInt
  object curliocmd extends _BindgenEnumCInt[curliocmd]:
    given _tag: Tag[curliocmd] = Tag.Int
    inline def define(inline a: CInt): curliocmd = a
  ...
  opaque type curlioerr = CInt
  object curlioerr extends _BindgenEnumCInt[curlioerr]:
    given _tag: Tag[curlioerr] = Tag.Int
    inline def define(inline a: CInt): curlioerr = a
  ...
  opaque type curlsocktype = CInt
  object curlsocktype extends _BindgenEnumCInt[curlsocktype]:
    given _tag: Tag[curlsocktype] = Tag.Int
    inline def define(inline a: CInt): curlsocktype = a
...
object aliases:
  ...
  object SOCKET: 
    given _tag: Tag[SOCKET] = UINT_PTR._tag
    inline def apply(inline o: UINT_PTR): SOCKET = o
    extension (v: SOCKET)
      inline def value: UINT_PTR = v

  opaque type UINT_PTR = CUnsignedLongLong
  object UINT_PTR: 
    given _tag: Tag[UINT_PTR] = Tag.ULong
    inline def apply(inline o: CUnsignedLongLong): UINT_PTR = o
    extension (v: UINT_PTR)
  ...
  opaque type curl_off_t = CLongLong
  object curl_off_t: 
    given _tag: Tag[curl_off_t] = Tag.Long
    inline def apply(inline o: CLongLong): curl_off_t = o
  ...
  type curl_socket_t = SOCKET
  object curl_socket_t: 
    given _tag: Tag[curl_socket_t] = SOCKET._tag
    inline def apply(inline o: SOCKET): curl_socket_t = o
    extension (v: curl_socket_t)
      inline def value: SOCKET = v

  opaque type curl_socklen_t = CInt
  object curl_socklen_t: 
    given _tag: Tag[curl_socklen_t] = Tag.Int
    inline def apply(inline o: CInt): curl_socklen_t = o
...
object constants:
  val CURL_HTTP_VERSION_NONE: CInt = 0
  val CURL_HTTP_VERSION_1_0: CInt = 1
  val CURL_HTTP_VERSION_1_1: CInt = 2
  val CURL_HTTP_VERSION_2_0: CInt = 3
  val CURL_HTTP_VERSION_2TLS: CInt = 4
  val CURL_HTTP_VERSION_2_PRIOR_KNOWLEDGE: CInt = 5
  val CURL_HTTP_VERSION_3: CInt = 30
  val CURL_HTTP_VERSION_3ONLY: CInt = 31
  val CURL_HTTP_VERSION_LAST: CInt = 32
  
  val CURL_RTSPREQ_NONE: CInt = 0
  val CURL_RTSPREQ_OPTIONS: CInt = 1
  val CURL_RTSPREQ_DESCRIBE: CInt = 2
  val CURL_RTSPREQ_ANNOUNCE: CInt = 3
  val CURL_RTSPREQ_SETUP: CInt = 4
  val CURL_RTSPREQ_PLAY: CInt = 5
  val CURL_RTSPREQ_PAUSE: CInt = 6
  val CURL_RTSPREQ_TEARDOWN: CInt = 7
  val CURL_RTSPREQ_GET_PARAMETER: CInt = 8
  val CURL_RTSPREQ_SET_PARAMETER: CInt = 9
  val CURL_RTSPREQ_RECORD: CInt = 10
  val CURL_RTSPREQ_RECEIVE: CInt = 11
  val CURL_RTSPREQ_LAST: CInt = 12
...
object all:
  ...
  export _root_.curl.aliases.SOCKET
  export _root_.curl.aliases.UINT_PTR
